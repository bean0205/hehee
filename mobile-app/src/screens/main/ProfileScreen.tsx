...
import TravelMapComponent from "../../components/common/TravelMapComponent";
  ...
  const continentData = [
    {
      ...
      totalCountries: 48,
      visited:
        countriesWithContinent.filter((c) => c.continent === "Châu Á").length >
        0,
    },
    {
      name: "Châu Âu",
      ...
      totalCountries: 44,
      visited:
        countriesWithContinent.filter((c) => c.continent === "Châu Âu").length >
        0,
    },
    {
      name: "Châu Phi",
      ...
      totalCountries: 54,
      visited:
        countriesWithContinent.filter((c) => c.continent === "Châu Phi")
          .length > 0,
    },
    {
      name: "Bắc Mỹ",
      ...
      totalCountries: 23,
      visited:
        countriesWithContinent.filter((c) => c.continent === "Bắc Mỹ").length >
        0,
    },
    {
      name: "Nam Mỹ",
      ...
      totalCountries: 12,
      visited:
        countriesWithContinent.filter((c) => c.continent === "Nam Mỹ").length >
        0,
    },
    {
      name: "Châu Đại Dương",
      ...
      totalCountries: 14,
      visited:
        countriesWithContinent.filter((c) => c.continent === "Châu Đại Dương")
          .length > 0,
    },
  ].map((continent) => ({
    ...continent,
    visitedCountries: countriesWithContinent.filter(
      (c) => c.continent === continent.name
    ).length,
    percentage:
      continent.totalCountries > 0
        ? Math.round(
            (countriesWithContinent.filter(
              (c) => c.continent === continent.name
            ).length /
          ...
          >
            <View style={styles.explorationHeader}>
              <Text style={styles.explorationTitle}>
                {t("profile.explorationJourney")}
              </Text>
              <View style={styles.explorationHeaderRight}>
                <Text style={styles.explorationPercentage}>
                  {stats.explorationPercentage}%
                </Text>
                  ...
                  <View
                    style={[
                      styles.continentCardProgressFill,
                      {
                        ...
                        backgroundColor: continent.visited
                          ? colors.primary.main
          ...
          <View style={styles.listContent}>
            ...
            <View style={styles.filterBar}>
              ...
              >
                <Text
                  style={[
                    styles.filterText,
                    filter === "visited" && styles.activeFilterText,
                  ]}
                >
                  {t("pin.visited")}
                </Text>
              ...
              >
                <Text
                  style={[
                    styles.filterText,
                    filter === "wantToGo" && styles.activeFilterText,
                  ]}
                >
                  {t("pin.wantToGo")}
                </Text>
            ...
            {filteredPins.map((pin) => (
              <PinCard
                ...
                pin={pin}
                onPress={() =>
                  navigation.navigate("PinDetails", { pinId: pin.id })
                }
              />
            ))}
