...
public class User {
    ...
    @Builder.Default
    private Integer visitedCountriesCount = 0;
    
    @Column(name = "visited_cities_count", nullable = false)
    @Builder.Default
    private Integer visitedCitiesCount = 0;
    
    @Column(name = "total_pins_count", nullable = false)
    @Builder.Default
    private Integer totalPinsCount = 0;
    ...
    @Builder.Default
    private String notesVisibility = "private";
    
    @Column(name = "bucketlist_visibility", nullable = false, length = 20)
    @Builder.Default
    private String bucketlistVisibility = "public";
